...
dropna(self, axis=0, how="any", thresh=None, subset=[None], inplace=False)
    axis : Возможные значения {0 или «индекс», 1 или «столбцы»}, по умолчанию 0. Если 0, капля строки с нулевыми значениями. Если 1, падение колонн с отсутствующими значениями.
    how : Возможные значения {‘any’, ‘all’}, по умолчанию “любой”. Если «любой», отбросьте строку/столбец, если какое-либо из значений нуль. Если «все», отбросьте строку/столбец, если все значения отсутствуют.
